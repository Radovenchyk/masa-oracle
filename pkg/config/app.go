...
func (c *AppConfig) setDefaultConfig() {
	...
	viper.SetDefault(TunnelListenPort, "8888")
	// TODO What is the default Cosmos port?
	viper.SetDefault(TunnelTargetPort, "8080")
...
func (c *AppConfig) setCommandLineConfig() error {
	...
	pflag.BoolVar(&c.TunnelEnabled, "tunnel-enabled", viper.GetBool(ProxyEnabled), "Enable CONNECT proxy")
	pflag.StringVar(&c.TunnelListenAddr, "tunnelListenAddr", viper.GetString(TunnelListenAddr), "Proxy listen address")
	pflag.Uint16Var(&c.TunnelTargetPort, "tunnelTargetPort", viper.GetUint16(TunnelTargetPort), "Proxy target port")
